...
* Services
  - for downloading songs, a worker needs to be started as QUEUE=file.downloader RAILS_ENV=production bundle exec rake environment resque:work. This machine needs to have DB access.
