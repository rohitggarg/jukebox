...
* Services
  ...
  - for playback on master you need to run resque worker 
    ``RAILS_ENV=production AIRBRAKE_KEY=<key> AIRBRAKE_URL=<url> DATABASE_URL=postgres://localhost REDIS_URL=<your redis> JUKEBOX_ADMIN_SECRET=<secret> QUEUE=jukebox.local bundle exec rake environment resque:work``
